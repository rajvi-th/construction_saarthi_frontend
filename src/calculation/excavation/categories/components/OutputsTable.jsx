                        ...
                        <div className="space-y-1">
                            ...
                            <div className="pt-1">
                                <p className="flex items-baseline gap-2">
                                    {displayLabel && output.formula && <span className="text-sm text-secondary min-w-0 md:min-w-[100px]">{displayLabel}</span>}
                                    {output.value} {output.unitKey ? t(output.unitKey) : (output.unit || '')}
                                </p>
                            </div>
                        </div>
                    </div>
