...
// Import icons
import mshapedRoofs from '../../../../assets/icons/mshapedRoofs.svg';
...
const MShapedRoof = () => {
    ...
    const calculationData = [
        { labelKey: 'roofArea.mShapedRoof.baseLengthA', symbol: 'A', value: `${(A / 1000).toFixed(3)} m` },
        { labelKey: 'roofArea.mShapedRoof.baseLengthB', symbol: 'B', value: `${(B / 1000).toFixed(3)} m` },
        { labelKey: 'roofArea.mShapedRoof.eaveLengthC', symbol: 'C', value: `${(C / 1000).toFixed(3)} m` },
        { labelKey: 'roofArea.mShapedRoof.riseH', symbol: 'H', value: `${(H / 1000).toFixed(3)} m` },
        { labelKey: 'roofArea.mShapedRoof.roomPrice', symbol: 'P', value: roomPrice, unitKey: 'roofArea.common.currencyPerSqM' },
    ];

    const detailedOutputs = [
        {
            titleKey: 'roofArea.mShapedRoof.results.roofArea',
            labelKey: 'roofArea.mShapedRoof.results.roofArea',
            labelSuffix: ' =',
        ...
        {
            titleKey: 'roofArea.mShapedRoof.results.roofCost',
            labelKey: 'roofArea.mShapedRoof.results.roofCost',
            labelSuffix: ' =',
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('roofArea.mShapedRoof.title')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={mshapedRoofs} alt="M shaped Roof Diagram" className=" object-contain" />
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className='grid md:grid-cols-3 gap-4'>
                            <InputField
                                ...
                                placeholder={t('roofArea.mShapedRoof.baseLengthA')}
                            />
                            <InputField
                                unit="mm"
                                value={baseLengthB}
                                onChange={(e) => setBaseLengthB(e.target.value)}
                                placeholder={t('roofArea.mShapedRoof.baseLengthB')}
                            />
                            <InputField
                                unit="mm"
                                value={eaveLengthC}
                                onChange={(e) => setEaveLengthC(e.target.value)}
                                placeholder={t('roofArea.mShapedRoof.eaveLengthC')}
                            />
                        </div>
                        <div className="grid md:grid-cols-2 gap-4">
                            <InputField
                                ...
                                placeholder={t('roofArea.mShapedRoof.riseH')}
                            />
                            <InputField
                                unit="mm"
                                suffix="₹/sq.m."
                                ...
                                placeholder={t('roofArea.mShapedRoof.roomPrice')}
                            />
                        </div>
                    </div>
                </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="bg-white rounded-xl border border-[#060C121A] overflow-hidden mb-8 overflow-x-auto">
                        <table className="w-full text-left border-collapse min-w-[320px]">
                            ...
                            <tbody className="divide-y divide-[#060C120A]">
                                {[
                                    { materialKey: 'roofArea.mShapedRoof.results.roofArea', quantity: roofArea.toFixed(3), unit: 'sq.m.' },
                                    { materialKey: 'roofArea.mShapedRoof.results.roofCost', quantity: roofCost.toFixed(3), unit: '₹' },
                                ].map((row, index) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_ROOF_AREA_M_SHAPED_ROOF_DETAILED, {
                                state: {
                                    calculationData,
            ...
            <DownloadPDFModal
                ...
                defaultTitle={t('roofArea.mShapedRoof.detailedTitle')}
