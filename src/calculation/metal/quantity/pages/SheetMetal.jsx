...
import sheetMetalDiagram from '../../../../assets/icons/sheetMetals.svg';
...
const SheetMetal = () => {
    ...
    // Volume = W * T * L (W, T in mm, L in m)
    const volume_m3_per_unit = (W * T * (L * 1000)) / 1000000000;
            ...
            <div className="bg-[#FAF5F0] rounded-3xl p-3 md:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={sheetMetalDiagram} alt="Sheet Diagram" className="w-full h-full object-contain max-h-48" />
                    </div>
                ...
                <div className="md:space-y-4 space-y-2 pt-6">
                    {/* Row 1: Width - W, Thickness - T, Length - L */}
