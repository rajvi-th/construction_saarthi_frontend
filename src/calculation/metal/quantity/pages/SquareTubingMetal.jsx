...
import squareTubingMetalDiagram from '../../../../assets/icons/squareTubingMetals.svg';

const SquareTubingMetal = () => {
    ...
    const l = parseFloat(sideL) || 0;
    const N_val = parseFloat(noOfUnits) || 0;
    const R_val = parseFloat(rateOfMetal) || 0;
    const dens_val = parseFloat(density) || 0;

    // Volume = a * b * l (Assuming solid volume calculation as per previous patterns)
    const volume_m3_per_unit = (a * b * l) / 1000000000;
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('metal.quantity.squareTubing')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#FAF5F0] rounded-3xl p-3 md:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={squareTubingMetalDiagram} alt="Square Tubing Diagram" className="w-full h-full object-contain max-h-48" />
                    </div>
                ...
                <div className="md:space-y-4 space-y-2 pt-6">
                    {/* Row 1: Side - a, Side - b, Side - L */}
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4">
                        <InputField
                            placeholder={t('metal.squareTubing.sideA')}
                            suffix="mm"
                            value={sideA}
                            onChange={(e) => setSideA(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.squareTubing.sideB')}
                            suffix="mm"
                            value={sideB}
                        ...
                        <div className="col-span-2 md:col-span-1">
                            <InputField
                                placeholder={t('metal.squareTubing.lengthL')}
                                suffix="m"
                                value={sideL}
                                onChange={(e) => setSideL(e.target.value)}
                            />
                        </div>
                    </div>
...
export default SquareTubingMetal;
