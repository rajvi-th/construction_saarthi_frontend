...
import beamMetalDiagram from '../../../../assets/icons/beamMetals.svg';
...
const BeamMetal = () => {
    ...
    // Area approx for I-Beam: (a - 2*T1) * T + 2 * (b * T1)
            ...
            <div className="bg-[#FAF5F0] rounded-3xl p-3 md:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={beamMetalDiagram} alt="Beam Diagram" className="w-full h-full object-contain max-h-48" />
                    </div>
                ...
                <div className="md:space-y-4 space-y-2 pt-6">
                    ...
                    <div className="grid grid-cols-2 gap-2 md:gap-4">
                        <InputField
                            placeholder={t('metal.beam.sideA')}
                            suffix="mm"
                            value={sideA}
                            onChange={(e) => setSideA(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.beam.sideB')}
                            suffix="mm"
                            value={sideB}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4">
                        <InputField
                            placeholder={t('metal.beam.thicknessT')}
                            suffix="mm"
                            value={thicknessT}
                            onChange={(e) => setThicknessT(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.beam.thicknessT1')}
                            suffix="mm"
                            value={thicknessT1}
                            onChange={(e) => setThicknessT1(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.beam.lengthL')}
                            suffix="m"
                            value={lengthL}
