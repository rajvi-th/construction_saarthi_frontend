...
import squareBarMetalDiagram from '../../../../assets/icons/squareBarMetals.svg';

const SquareBarMetal = () => {
    ...
    // Volume = W * W * L
    const volume_m3_per_unit = (W_val * W_val * L_val) / 1000000000;
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('metal.quantity.squareBar')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#FAF5F0] rounded-3xl p-3 md:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={squareBarMetalDiagram} alt="Square Bar Diagram" className="w-full h-full object-contain max-h-48" />
                    </div>
                ...
                <div className="md:space-y-4 space-y-2 pt-6">
                    {/* Row 1: Width - W, Length - L */}
                    <div className="grid grid-cols-2 gap-2 md:gap-4">
                        <InputField
                            placeholder={t('metal.squareBar.width')}
                            suffix="mm"
                            value={w}
                            onChange={(e) => setW(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.squareBar.length')}
                            suffix="mm"
                            value={length}
