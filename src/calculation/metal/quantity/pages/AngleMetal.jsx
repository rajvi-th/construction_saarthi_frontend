...
import angleMetalDiagram from '../../../../assets/icons/angleMetals.svg';
...
const AngleMetal = () => {
    ...
    const T1 = parseFloat(thicknessT1) || 0; // Usually same as T for Angle
    ...
    // Area approx for L-Angle: (a * T) + (b - T) * T1 (if T and T1 differ)
    const area_mm2 = (a * T) + ((b - T) * T1);
            ...
            <div className="bg-[#FAF5F0] rounded-3xl p-3 md:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={angleMetalDiagram} alt="Angle Diagram" className="w-full h-full object-contain max-h-48" />
                    </div>
                ...
                <div className="md:space-y-4 space-y-2 pt-6">
                    ...
                    <div className="grid grid-cols-2 gap-2 md:gap-4">
                        <InputField
                            placeholder={t('metal.angle.sideA')}
                            suffix="mm"
                            value={sideA}
                            onChange={(e) => setSideA(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.angle.sideB')}
                            suffix="mm"
                            value={sideB}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
                        <InputField
                            placeholder={t('metal.angle.thicknessT')}
                            suffix="mm"
                            value={thicknessT}
                            onChange={(e) => setThicknessT(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.angle.lengthL')}
                            suffix="m"
                            value={lengthL}
                    ...
                    {/* Row 3: No of Units, Rate of Metal */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
                        <InputField
