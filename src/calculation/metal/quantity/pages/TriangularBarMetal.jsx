...
import triangularBarMetalDiagram from '../../../../assets/icons/triangularBarMetals.svg';

const TriangularBarMetal = () => {
    ...
    const area_mm2 = (Math.sqrt(3) / 4) * Math.pow(a, 2);
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('metal.quantity.triangularBar')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#FAF5F0] rounded-3xl p-3 md:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={triangularBarMetalDiagram} alt="Triangular Bar Diagram" className="w-full h-full object-contain max-h-48" />
                    </div>
                ...
                <div className="md:space-y-4 space-y-2 pt-6">
                    ...
                    <div className="space-y-2 pt-2">
                        <h3 className="font-medium text-primary ml-1">Type of Metal</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <Dropdown
                                value={metalType}
                                onChange={handleMetalTypeChange}
                                options={metalDensities}
            ...
            {showResult && (
                <div className="mt-10 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
                    <h2 className="text-lg font-medium text-primary mb-3">Result</h2>
                    ...
                    <div className="bg-white rounded-xl border border-[#060C121A] overflow-hidden overflow-x-auto">
                        <table className="w-full text-left border-collapse min-w-[320px]">
                            ...
                            <tbody className="divide-y divide-[#060C120A]">
                                {[
                                    { material: 'Unit Weight', quantity: unitWeight.toFixed(3), unit: 'Kg' },
                                    { material: 'Total Weight', quantity: totalWeight.toFixed(3), unit: 'Kg' },
                                    { material: 'Total Price', quantity: totalPrice.toFixed(2), unit: '₹' },
                                ].map((row, rowIndex) => (
...
export default TriangularBarMetal;
