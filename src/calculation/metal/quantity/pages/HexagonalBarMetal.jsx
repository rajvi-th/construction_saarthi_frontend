...
import hexagonalBarMetalDiagram from '../../../../assets/icons/hexagonalBarMetals.svg';

const HexagonalBarMetal = () => {
    ...
    const area_mm2 = (3 * Math.sqrt(3) / 2) * Math.pow(a, 2);
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('metal.quantity.hexagonalBar')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#FAF5F0] rounded-3xl p-3 md:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={hexagonalBarMetalDiagram} alt="Hexagonal Bar Diagram" className="w-full h-full object-contain max-h-48" />
                    </div>
                ...
                <div className="md:space-y-4 space-y-2 pt-6">
                    ...
                    <div className="grid grid-cols-2 gap-2 md:gap-4">
                        <InputField
                            placeholder={t('metal.hexagonalBar.sideA')}
                            suffix="mm"
                            value={sideA}
                            onChange={(e) => setSideA(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.hexagonalBar.lengthL')}
                            suffix="m"
                            value={lengthL}
                    ...
                    {/* Row 2: No of Units, Rate of Metal (Added as per global instruction) */}
...
export default HexagonalBarMetal;
