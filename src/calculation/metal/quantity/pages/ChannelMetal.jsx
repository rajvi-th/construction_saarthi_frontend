...
import channelMetalDiagram from '../../../../assets/icons/channelMetals.svg';
...
const ChannelMetal = () => {
    ...
    const T1 = parseFloat(thicknessT1) || 0;
    ...
    // Area approx for Channel: (a - 2*T1) * T + 2 * (b * T1)
    const area_mm2 = ((a - 2 * T1) * T) + (2 * b * T1);
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('metal.quantity.channel')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#FAF5F0] rounded-3xl p-3 md:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={channelMetalDiagram} alt="Channel Diagram" className="w-full h-full object-contain max-h-48" />
                    </div>
                ...
                <div className="md:space-y-4 space-y-2 pt-6">
                    ...
                    <div className="grid grid-cols-2 gap-2 md:gap-4">
                        <InputField
                            placeholder={t('metal.channel.sideA')}
                            suffix="mm"
                            value={sideA}
                            onChange={(e) => setSideA(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.channel.sideB')}
                            suffix="mm"
                            value={sideB}
                    ...
                    {/* Row 2: Thickness - T, Thickness - T1, Length - L */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4">
                        <InputField
                            placeholder={t('metal.channel.thicknessT')}
                            suffix="mm"
                            value={thicknessT}
                            onChange={(e) => setThicknessT(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.channel.thicknessT1')}
                            suffix="mm"
                            value={thicknessT1}
                            onChange={(e) => setThicknessT1(e.target.value)}
                        />
                        <InputField
                            placeholder={t('metal.channel.lengthL')}
                            suffix="m"
                            value={lengthL}
