...
import circularSwimmingPoolIcon from '../../../../assets/icons/circularSwimmingPools.svg';

const CircularSwimmingPool = () => {
    ...
    const volumeBase = PI * Math.pow(R, 2) * D;
    ...
    const calculationData = [
        { labelKey: 'swimmingPool.circular.radius', symbol: 'r', value: `${R} ${t('concrete.byVolume.mUnit')}` },
        { labelKey: 'swimmingPool.circular.depth', symbol: 'd', value: `${D} ${t('concrete.byVolume.mUnit')}` },
    ];

    const detailedOutputs = [
        {
            titleKey: 'swimmingPool.circular.results.volume',
            labelKey: 'swimmingPool.circular.results.volume',
            labelSuffix: ' =',
            formula: 'π X r² X d X 1000',
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('swimmingPool.circular.title')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#F9F4EE] rounded-2xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center">
                        <img src={circularSwimmingPoolIcon} alt={t('swimmingPool.circular.title')} className="w-full h-full object-contain" />
                    </div>
                ...
                <div className="space-y-4 pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <InputField
                            ...
                            placeholder={t('swimmingPool.circular.radius')}
                        />
                        <InputField
                            unit={t('concrete.byVolume.mUnit')}
                            value={depth}
                            onChange={(e) => setDepth(e.target.value)}
                            placeholder={t('swimmingPool.circular.depth')}
                        />
                    </div>
                </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                        ...
                        <table className="w-full text-left border-collapse min-w-[320px]">
                            ...
                            <tbody className="divide-y divide-[#060C120A]">
                                <tr className="hover:bg-[#F9F9F9] transition-colors">
                                    <td className="px-6 py-4 text-sm text-primary border-r border-[#060C120A]">{t('swimmingPool.circular.results.volume')}</td>
                    ...
                    <div className="flex justify-end">
                        <Button
                            variant="primary"
                            onClick={() => navigate('/calculation/swimming-pool/circular/detailed', {
                                state: {
                                    calculationData,
            ...
            <DownloadPDFModal
                ...
                defaultTitle={t('swimmingPool.circular.detailedTitle')}
...
export default CircularSwimmingPool;
