...
import lShapeSwimmingPoolIcon from '../../../../assets/icons/lShapeSwimmingPools.svg';

const LShapeSwimmingPool = () => {
    ...
    // L-Shape Area = (A * D) + (C * (B - D))
    const baseArea = (A * D_INPUT) + (C * (B - D_INPUT));
    ...
    const calculationData = [
        { labelKey: 'swimmingPool.lShape.lengthA', symbol: 'A', value: `${A} ${t('concrete.byVolume.mUnit')}` },
        { labelKey: 'swimmingPool.lShape.lengthB', symbol: 'B', value: `${B} ${t('concrete.byVolume.mUnit')}` },
        { labelKey: 'swimmingPool.lShape.c', symbol: 'C', value: `${C} ${t('concrete.byVolume.mUnit')}` },
        { labelKey: 'swimmingPool.lShape.d', symbol: 'D', value: `${D_INPUT} ${t('concrete.byVolume.mUnit')}` },
        { labelKey: 'swimmingPool.lShape.depth', symbol: 'd', value: `${DEPTH} ${t('concrete.byVolume.mUnit')}` },
    ];

    const detailedOutputs = [
        {
            titleKey: 'swimmingPool.lShape.results.volume',
            labelKey: 'swimmingPool.lShape.results.volume',
            labelSuffix: ' =',
            formula: '((A X D) + (C X (B - D))) X d X 1000',
        ...
        },
        {
            ...
            labelKey: 'swimmingPool.lShape.results.volume',
            labelSuffix: ' =',
            formula: '((A X D) + (C X (B - D))) X d X 264',
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('swimmingPool.lShape.title')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#F9F4EE] rounded-2xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center">
                        <img src={lShapeSwimmingPoolIcon} alt={t('swimmingPool.lShape.title')} className="w-full h-full object-contain" />
                    </div>
                ...
                <div className="space-y-4 pt-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <InputField
                            ...
                            placeholder={t('swimmingPool.lShape.lengthA')}
                        />
                        <InputField
                            unit={t('concrete.byVolume.mUnit')}
                            value={lengthB}
                            onChange={(e) => setLengthB(e.target.value)}
                            placeholder={t('swimmingPool.lShape.lengthB')}
                        />
                        <InputField
                            unit={t('concrete.byVolume.mUnit')}
                            value={c}
                            onChange={(e) => setC(e.target.value)}
                            placeholder={t('swimmingPool.lShape.c')}
                        />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <InputField
                            ...
                            placeholder={t('swimmingPool.lShape.d')}
                        />
                        <InputField
                            unit={t('concrete.byVolume.mUnit')}
                            value={depth}
                            onChange={(e) => setDepth(e.target.value)}
                            placeholder={t('swimmingPool.lShape.depth')}
                        />
                    </div>
                </div>
                ...
                showResult && (
                    <div className="mt-10 animate-fade-in pb-10">
                            ...
                            <table className="w-full text-left border-collapse min-w-[320px]">
                                ...
                                <tbody className="divide-y divide-[#060C120A]">
                                    <tr className="hover:bg-[#F9F9F9] transition-colors">
                                        <td className="px-6 py-4 text-sm text-primary border-r border-[#060C120A]">{t('swimmingPool.lShape.results.volume')}</td>
                        ...
                        <div className="flex justify-end">
                            <Button
                                variant="primary"
                                onClick={() => navigate('/calculation/swimming-pool/l-shape/detailed', {
                                    state: {
                                        calculationData,
            ...
            <DownloadPDFModal
                ...
                defaultTitle={t('swimmingPool.lShape.detailedTitle')}
...
export default LShapeSwimmingPool;
