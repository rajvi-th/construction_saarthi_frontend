...
// Import icons
import ushBar from '../../../../assets/icons/ushBar.svg';
...
const UShapeBar = () => {
    ...
    const C = parseFloat(lengthC) || 0;
    const d = parseFloat(diameter) || 0;
    const N = parseFloat(noOfBars) || 0;

    // Length of Each Bar L1 = A + B + C - (4 * d)
    // Note: A, B, C are in meters. d is in mm.
    // Convert d to meters for subtraction: d (m) = d / 1000
    const lengthOfEachBar = (A + B + C) - (4 * d / 1000);
    ...
    const calculationData = [
        ...
        { labelKey: 'steel.cutting.lengthC', name: t('steel.cutting.lengthC'), symbol: 'C', value: `${lengthC} m` },
    ...
    const detailedOutputs = [
        ...
        },
        {
            ...
            labelSuffix: '=',
            formula: '((((A+B+C-(4Xd))XN)XdXd)/162.28)',
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={ushBar} alt="U Shape Bar Diagram" className="w-full h-full object-contain" />
                    </div>
                ...
                <div className="space-y-4 pt-4">
                    <div className='grid md:grid-cols-3 gap-4'>
                        ...
                        <InputField
                            ...
                            placeholder={t('steel.cutting.lengthC')}
                        />
                    </div>
                    <InputField
                        unit="mm"
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="flex justify-end gap-6">
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_U_SHAPE_BAR_DETAILED, {
                                state: {
                                    calculationData,
