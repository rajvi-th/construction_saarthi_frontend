...
const FootingType2 = () => {
    ...
    const calculationData = [
        ...
        { name: t('steel.footing.d3'), symbol: 'D3', value: `${d3} mm` },
        { name: t('steel.footing.d4'), symbol: 'D4', value: `${d4} mm` },
        { name: t('steel.footing.s1'), symbol: 'S1', value: `${s1} mm` },
        { name: t('steel.footing.s2'), symbol: 'S2', value: `${s2} mm` },
        { name: t('steel.footing.s3'), symbol: 'S3', value: `${s3} mm` },
        { name: t('steel.footing.s4'), symbol: 'S4', value: `${s4} mm` },
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <div className="flex bg-white rounded-2xl border border-[#060C121A] focus-within:border-accent/40 transition-all overflow-hidden h-[58px]">
                            <div className="flex-1 px-6 flex items-center">
                                <span className="text-secondary font-medium mr-4">{t('steel.footing.noOfFooting')}</span>
                                <input
                                    type="text"
                                    value={noOfFooting}
                                    onChange={(e) => setNoOfFooting(e.target.value)}
                                    className="flex-1 text-base text-primary focus:outline-none font-medium h-full"
                                    placeholder={t('steel.weight.wastagePlaceholder')}
                                />
                            </div>
                            <div className="flex items-center px-4 bg-gray-50/50 border-l border-[#060C121A]">
                                <span className="text-secondary font-medium uppercase">NOS</span>
                            </div>
                        </div>
                    </div>
                    <div className="grid grid-cols-1 gap-6">
                            ...
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_FOOTING_TYPE2_DETAILED, {
                                state: {
                                    ...
                                    outputs: [
                                        ...
                                        { title: 'D1', formula: 'len1 * nos1 * w1 * n', value: `${d1Weight.toFixed(3)} Kg` },
                                        { title: 'D2', formula: 'len2 * nos2 * w2 * n', value: `${d2Weight.toFixed(3)} Kg` },
                                        { title: 'D3', formula: 'len1 * nos1 * w3 * n', value: `${d3Weight.toFixed(3)} Kg` },
                                        { title: 'D4', formula: 'len2 * nos2 * w4 * n', value: `${d4Weight.toFixed(3)} Kg` },
                                        { title: 'Total Steel', formula: 'D1 + D2 + D3 + D4', value: `${totalSteel.toFixed(3)} Kg` },
