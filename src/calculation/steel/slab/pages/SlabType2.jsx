...
// Import icons
import slType2 from '../../../../assets/icons/slType2.svg';
...
const SlabType2 = () => {
    ...
    // Calculation Logic (Following formulas from Image 4)
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center">
                        <img src={slType2} alt="Slab Diagram" className="w-full h-full object-contain" />
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_SLAB_TYPE2_DETAILED, {
                                state: {
                                    calculationData,
