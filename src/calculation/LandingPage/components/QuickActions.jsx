        ...
        {QUICK_ACTIONS.map((action) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`w-10 h-10 sm:w-14 sm:h-14 rounded-full flex items-center justify-center mb-3 sm:mb-4 border border-black-soft relative
                                ${
                                  action.isLocked
                                    ? "bg-[linear-gradient(180deg,rgba(6,12,18,0.6)_0%,rgba(6,12,18,0.4)_100%)] backdrop-blur-[2px]"
                  ...
                  <>
                    {action.icon && (
                      <img
                        src={action.icon}
                        alt={title}
                        className="w-5 h-5 sm:w-7 sm:h-7 object-contain opacity-50"
                      />
                    )}
