/**
 * Custom hook for fetching projects for Finance feature
...
import { getNotesProjects } from '../../notes/api/notesApi';
import { showError } from '../../../utils/toast';

export const useFinanceProjects = (workspaceId) => {
  ...
  const fetchProjects = useCallback(async (forceRefetch = false) => {
    ...
    try {
      ...
      console.error('Error fetching projects for finance:', err);
...
export default useFinanceProjects;
