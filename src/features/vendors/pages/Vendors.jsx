    ...
    <div className="max-w-7xl mx-auto">
      ...
      >
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start sm:items-center w-full lg:w-auto">
          <div className="flex-1 w-full sm:w-auto sm:flex-none">
            <SearchBar
              placeholder={t('searchVendorsPlaceholder', { defaultValue: 'Search vendors' })}
              value={searchQuery}
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          message={searchQuery
            ? t('emptyState.noResultsMessage', { defaultValue: 'No vendors found matching your search. Try adjusting your search terms.' })
            : t('emptyState.noVendorsMessage', { defaultValue: 'You haven\'t added any vendors yet. Add your first vendor to get started.' })
          }
          actionLabel={!searchQuery ? t('form.addVendor', { defaultValue: 'Add Vendor' }) : undefined}
